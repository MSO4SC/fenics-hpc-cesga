...
#ifndef __DIRICHLETBCCG2VCG1_H
#define __DIRICHLETBCCG2VCG1_H
...
class DirichletBC_CG2v_CG1: public BoundaryCondition
...
public:
  ...
  DirichletBC_CG2v_CG1(Mesh& mesh, SubDomain& sub_domain, uint subsys, Function* value_fun );

  /// Destructor
  ~DirichletBC_CG2v_CG1();
...
private:
  ...
  void applyDirichletBC_CG2v_CG1(Matrix& A, Matrix& As, Vector&, Mesh& mesh, uint node,
...
inline void DirichletBC_CG2v_CG1::Aset(Matrix& A, uint row, uint col, real value)
{
  A.set(&value, 1, &row, 1, &col);
}

inline void DirichletBC_CG2v_CG1::bset(Vector& b, uint row, real value)
{
  b.set(&value, 1, &row);
}
