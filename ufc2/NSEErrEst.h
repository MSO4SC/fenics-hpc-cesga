...
#ifndef __NSEERREST_H
#define __NSEERREST_H
...
class nseerrest_finite_element_0: public ufc::finite_element
{
public:

  /// Constructor
  nseerrest_finite_element_0();

  /// Destructor
  virtual ~nseerrest_finite_element_0();
...
#ifndef UFC_BACKWARD_COMPATIBILITY
class nseerrest_dofmap_0: public ufc::dofmap
#else
class nseerrest_dofmap_0: public ufc::dof_map
#endif
{
private:
...
class nseerrest_cell_integral_0_0: public ufc::cell_integral
{
public:

  /// Constructor
  nseerrest_cell_integral_0_0();

  /// Destructor
  virtual ~nseerrest_cell_integral_0_0();
...
class nseerrest_form_0: public ufc::form
{
public:
...
public:
  ...
  CoefficientSpace_Rc(const dolfin::Mesh& mesh):
    dolfin::FunctionSpace(dolfin::reference_to_no_delete_pointer(mesh),
                          const dolfin::FiniteElement* (new dolfin::FiniteElement(ufc::finite_element* (new nseerrest_finite_element_0()))),
                          const dolfin::DofMap *(new dolfin::DofMap(ufc::dofmap* (new nseerrest_dofmap_0()), mesh)))
  {
    // Do nothing
  }
...
public:
    ...
    dolfin::Form(0, 6), h(*this, 0), cv(*this, 1), Rm(*this, 2), Rc(*this, 3), wm(*this, 4), wc(*this, 5)
  {
    ...
    _ufc_form = const ufc::form* (new nseerrest_form_0());
  }
...
class NSEErrEstFunctional : public dolfin::Form
{
public:

  NSEErrEstFunctional(dolfin::Function& w0, dolfin::Function& w1, dolfin::Function& w2, dolfin::Function& w3, dolfin::Function& w4, dolfin::Function& w5) : dolfin::Form()
  {
